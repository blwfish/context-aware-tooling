...
# ---------------------------------------------------------------------------
# Re-exports from refactored modules (backward compatibility)
# ---------------------------------------------------------------------------
...
# Note: create_working_copy, record_pipeline_step, check_build_fit,
# PRINTER_VOLUMES, PIPELINE_NAME, PIPELINE_VERSION, and _METADATA_GROUP
# are now imported from pipeline.py / constants.py at the top of this
# section and re-exported for backward compatibility.
